...
export const SITE_TITLE = 'The Deep Field';
export const SITE_DESCRIPTION = 'A calm, thoughtful space for ideas, writing, and exploration at the edge of knowledge.';

// Author
export const AUTHOR_NAME = 'Aditya Sasidhar';
